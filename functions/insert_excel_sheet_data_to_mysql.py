...
def insert_excel_data_to_mysql(final_excel_sheets_path):
    ...
    try:
        ...
        for index, row in df.iterrows():
            ...
            """
            values = (cci_config.source_name, row["combination_reg_no"], row["description"], row["under_section"], row["decision_date"], row["order_link"], row["orderpdf_file_name"], row["orderpdf_file_path"])
